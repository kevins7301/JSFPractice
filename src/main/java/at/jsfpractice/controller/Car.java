...
public class Car implements Serializable {
    ...
    private int carStructSize = 4;

	public int getCarStructSize() {
		return carStructSize;
	}

	public void setCarStructSize(int carStructSize) {
		this.carStructSize = carStructSize;
	}
	
    public Object CarValue(int count)
    {
    	if (count == 0)
    	{
